...
Code: [github.com/younissk/falcon-twig](https://github.com/younissk/falcon-twig). Dataset: [github.com/younissk/tool-calling-mix](https://github.com/younissk/tool-calling-mix) and [huggingface.co/datasets/younissk/tool-calling-mix](https://huggingface.co/datasets/younissk/tool-calling-mix). Model: [huggingface.co/younissk/Falcon-Twig-7B](https://huggingface.co/younissk/Falcon-Twig-7B).
